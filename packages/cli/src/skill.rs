...
const SOURCE_FILES: &[SourceFile] = &[
    ...
    SourceFile {
        resource: GuideResource {
            topic: "comfyui-video-example",
            path: "examples/comfyui-video.json",
            media_type: "application/json",
        },
        content: include_str!("../../../.agents/skills/forge-use/examples/comfyui-video.json"),
    },
    SourceFile {
        resource: GuideResource {
    ...
    SourceFile {
        ...
        content: include_str!("../../../.agents/skills/forge-use/references/project-assets.md"),
    },
    SourceFile {
        resource: GuideResource {
            topic: "audio",
...
mod guide_tests {
    ...
    fn guide_defaults_to_overview_and_resolves_each_topic_and_exact_path() {
        ...
        let expected = [
            ...
            (
                "comfyui-video-example",
                "examples/comfyui-video.json",
                "application/json",
            ),
            (
